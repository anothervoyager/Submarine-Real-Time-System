...
class Simulation2(QObject):
    def __init__(self, main_window):
        ...
        self.timer_crictical_temperature = QTimer()
        self.timer_crictical_temperature.setSingleShot(True)  # Таймер сработает один раз
        self.timer_crictical_temperature.timeout.connect(self.check_temperature)  # Подключаем сигнал таймера к функции

        # Запускаем таймер
        self.timer_crictical_temperature.start(15000)  # 15000 миллисекунд = 15 секунд
        ...
        self.main_window.ui.widget_graphic_2.setLayout(layout)
    ...
    def play_audio2(self, file_path):
        """Проигрывает MP3 файл."""
        if self.is_audio_on_2:
        ...
        self.is_audio_on_2 = True  # Устанавливаем, что аудио на данный момент играет

    def stop_audio_2(self):
        """Останавливает воспроизведение"""
        pygame.mixer.music.stop()  # Останавливаем воспроизведение
        self.is_audio_on_2 = False  # Устанавливаем, что аудио не играет
    ...
    def update_graph(self):
        ...
        # Настройка графика
        self.plot_widget.setTitle("Температура и уровень кислорода в отсеке 2", color='w')  # Цвет заголовка
    ...
    def update_ui(self):
        ...
        self.main_window.ui.label_temperature_2.setText(str(f"{self.temperature_cell_1:.2f}"))
        self.main_window.ui.label_oxygen_2.setText(str(f"{self.oxygen_room_1:.2f}"))
    ...
    def alarm_check_cell_1(self):
        if (self.oxygen_room_1 <= 17) or (self.temperature_cell_1 >= 38):
            self.main_window.ui.button_cell_2.setStyleSheet("background-color: rgba(217, 4, 41, 0.29); color: white; border-radius: 0px;")
            self.play_audio2('sounds/alarm2.mp3')
        else:
            self.main_window.ui.button_cell_2.setStyleSheet("background-color: rgba(0, 166, 251, 0.42); color: white; border-radius: 0px;")
            if self.is_audio_on_2:
                self.stop_audio_2()
