...
class Simulation(QObject):
    def __init__(self, main_window):
        ...
        # переменные для экономических показателей
        self.support_expenses = 0
        self.oxygen_expenses = 0
        self.cooling_expenses = 0
        self.expenses = 0
        ...
        self.main_window.ui.widget_graphic_1.setLayout(layout)
    ...
    def economics(self):
        self.support_expenses += 84
        self.expenses += self.support_expenses
    ...
    def play_audio(self, file_path):
        ...
        self.is_audio_on = True  # Устанавливаем, что аудио на данный момент играет

    def stop_audio(self):
        """Останавливает воспроизведение"""
        pygame.mixer.music.stop()  # Останавливаем воспроизведение
        self.is_audio_on = False  # Устанавливаем, что аудио не играет
    ...
    def update_graph(self):
        ...
        # Настройка графика
        self.plot_widget.setTitle("Температура и уровень кислорода в отсеке 1", color='w')  # Цвет заголовка
    ...
    def update_ui(self):
        ...
        self.main_window.ui.label_temperature_1.setText(str(f"{self.temperature_cell_1:.2f}"))
        self.main_window.ui.label_oxygen_1.setText(str(f"{self.oxygen_room_1:.2f}"))
        self.main_window.ui.label_expenses.setText(str(self.expenses))
        self.main_window.ui.label_repair_expenses.setText(str(self.repair_expenses))
        self.main_window.ui.label_support_expenses.setText(str(self.support_expenses))
        self.main_window.ui.label_oxygen_expenses.setText(str(self.oxygen_expenses))
        self.main_window.ui.label_cooling_expenses.setText(str(self.cooling_expenses))
    ...
    def alarm_check_cell_1(self):
        if (self.oxygen_room_1 <= 17) or (self.temperature_cell_1 >= 38):
            self.main_window.ui.button_cell_1.setStyleSheet("background-color: rgba(217, 4, 41, 0.29); color: white; border-radius: 0px;")
            self.play_audio('sounds/alarm.mp3')
        else:
